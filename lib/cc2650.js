...
CC2650SensorTag.prototype.enableMPU9250 = function(mask, callback) {
  ...
  // @manuelbruschi changed 0x007f to 0x0038 so only accelerometer is enabled
  this.writeUInt16LECharacteristic(MPU9250_UUID, MPU9250_CONFIG_UUID, 0x0038, callback);
};
