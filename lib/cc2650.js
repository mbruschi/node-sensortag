...
var MPU9250_ACCELEROMETER_MASK              = 0x00B8;
...
CC2650SensorTag.prototype.enableMPU9250 = function(mask, callback) {
  ...
  // @manuelbruschi changed 0x007f to 0x00B8 so only accelerometer and WOM is enabled
  this.writeUInt16LECharacteristic(MPU9250_UUID, MPU9250_CONFIG_UUID, 0x00B8, callback);
};
